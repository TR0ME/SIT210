...
/**
 * Classe Abstraite d'un composant transmetteur d'informations dont les
 * éléments sont de type R en entrée et de type E en sortie; l'entrée du
 * transmetteur implémente l'interface DestinationInterface, la sortie du
 * transmetteur implémente l'interface SourceInterface
 * 
 * @author prou
 */
public abstract class Transmetteur<R, E> implements DestinationInterface<R>, SourceInterface<E> {
	 ...
	 * la classe abstraite Transmetteur
	 */
	public Transmetteur() {
